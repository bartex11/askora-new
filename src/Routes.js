...
import Legalisation from './site/Legalisation';
import Prices from './site/Prices';
import Translations from './site/Translations';
import Vouchers from './site/Vouchers';
  ...
  render () {
    return (
      <Switch>
        ...
        <Route exact path="/legalisation" component={Legalisation} />
